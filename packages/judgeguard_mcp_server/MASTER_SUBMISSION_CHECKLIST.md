...
- [x] **README ima setup/run/test instrukcije.**  
  *Dokaz:* [`packages/judgeguard_mcp_server/README.md`](./README.md) sadrži kompletna uputstva za instalaciju, pokretanje, testiranje i primere `curl` poziva.
- [x] **Repo je public sa licencom ili privatno podeljen na ispravan način.**  
  *Dokaz:* Zvanična MIT licenca u [`packages/judgeguard_mcp_server/LICENSE`](./LICENSE).
- [ ] **Video je javno dostupan, na engleskom ili preveden, kraći od 3 minuta.**  
  *Akcija:* Skripta pripremljena na tačno 2:45 u [`packages/judgeguard_mcp_server/DEMO_VIDEO_SCRIPT.md`](./DEMO_VIDEO_SCRIPT.md). Korisnik snima video i postavlja ga na YouTube/Loom (unlisted ili public).
